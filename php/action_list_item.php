...
if (isset($_POST['title'])) {
    ...
    $price = $_POST['price'];
    $stmt = $db->prepare('INSERT INTO Items (seller_id, title, description, price, condition, category, location, cellphone) VALUES (:seller_id,:title,:description,:price,:condition,:category,:location,:cellphone)');
